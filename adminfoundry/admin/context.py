...
:class:`adminfoundry.core.runtime.AdminRuntime`. It carries:

* the resolved :class:`~adminfoundry.providers.base.AdminPrincipal`
  (None for anonymous),
* the resolved :class:`~adminfoundry.providers.base.AdminTenant`
