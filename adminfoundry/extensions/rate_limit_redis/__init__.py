...
Plug-in backend for :class:`adminfoundry.auth.rate_limiter.RateLimiterBackend`.
Like :mod:`adminfoundry.extensions.storage_s3`, this extension does NOT mount
...
from adminfoundry.extensions.rate_limit_redis.backend import RedisLoginRateLimiter
