...
Plug-in backend for :class:`adminfoundry.storage.StorageBackend`. The
...
Requires ``boto3``. Install via the optional extras::
    ...
    pip install adminfoundry[storage-s3]
...
from adminfoundry.extensions.storage_s3.backend import S3StorageBackend
