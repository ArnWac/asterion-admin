...
Implements :class:`~adminfoundry.storage.StorageBackend` against any
...
:class:`~adminfoundry.storage.LocalFileStorage` (which dispatches
...
from adminfoundry.storage.base import StoredObject
...
def _import_boto3() -> tuple[Any, Any]:
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install with: pip install adminfoundry[storage-s3]"
        ) from exc
