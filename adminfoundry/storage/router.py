...
from adminfoundry.storage.base import StorageBackend
from adminfoundry.storage.errors import ObjectNotFound, StorageRejected
...
async def upload(
    ...
    cfg = request.app.state.adminfoundry.config
