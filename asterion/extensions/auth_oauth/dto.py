...
:mod:`asterion.extensions.auth_oauth.models` as
...
class ExternalIdentityData:
    ...
    :class:`~asterion.extensions.auth_oauth.models.ExternalIdentity`
...
class OAuthProviderConfig:
    ...
    :class:`~asterion.extensions.auth_oauth.base.OAuthProvider`
    instance, not here.
    """
